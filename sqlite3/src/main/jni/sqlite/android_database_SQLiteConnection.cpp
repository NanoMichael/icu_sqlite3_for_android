...
static JNINativeMethod sMethods[] =
{
    ...
    // !FIXME ADDED TO ENABLE LOAD EXTENSION
    { "nativeEnableLoadExtension", "(JZ)V", (void*)nativeEnableLoadExtension }
};
