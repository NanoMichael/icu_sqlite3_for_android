...
public final class SQLiteConnectionPool implements Closeable {
	...
	/**
	 * Enable or disable load extension
	 *
	 * @param enable Flag enable or disable
	 */
	public void enableLoadExtension(boolean enable) {
		synchronized (mLock) {
			if (!mAcquiredConnections.isEmpty() || mAvailablePrimaryConnection == null) {
				throw new IllegalStateException("Cannot enable load extension while database is in use");
			}
			mAvailablePrimaryConnection.enableLoadExtension(enable);
		}
	}
